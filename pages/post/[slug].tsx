  ...
  <main>
        ...
        <article className="max-w-3xl mx-auto p-5">
            ...
            <div className="flex items-center space-x-2">
                ...
                <p className="font-extralight text-sm">
                    Blog post by <span className="text-green-800">{post.author.name}</span> - Published at {new Date(post._createdAt).toLocaleString()}
                </p>
            </div>
        ...
        <hr className="max-w-lg my-5 mx-auto border border-yellow-500" />
                ...
                {submitted ? (
                    ...
                    <h3 className="text-sm text-yellow-500">Enjoy the bitcoin</h3>
                    <h4 className="text-3xl font-bold">Leave feedback below!</h4>
                    ...
                    <label className="block mb-5" htmlFor="">
                        ...
                        w-full ring-yellow-500 outline-none focus:ring" placeholder="Elon Musk" type="text" />
                    </label>
                    <label className="block mb-5" htmlFor="">
                        ...
                        className="shadow border rounded py-2 px-3 form-input mt-1 block
                        w-full ring-yellow-500 outline-none focus:ring" placeholder="Elon Musk" type="email" />
                    </label>
                    <label className="block mb-5" htmlFor="">
                        ...
                        w-full ring-yellow-500 outline-none focus:ring" placeholder="Elon Musk" rows={8} />
                    </label>
        
                    {/* errors will return when field validation fields */}
                    ...
                    py-2 px-4 rounded cursor-pointer" type="submit" name="" id="" />
                </form>
                )}
